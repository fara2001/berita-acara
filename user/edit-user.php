...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                <th>Username</th>
                <td><input type="text" name="username" class="form-control" value="<?php echo $data['username']; ?>" readonly></td>
            </tr>
            <tr>
                <th>Password</th>
                <td>
            ...
            <tr>
                ...
                <td>
                    <select name="role" class="form-control" required>
                        ...
                        <option value="editor" <?php if ($data['role'] == 'editor') echo 'selected'; ?>>Editor</option>
                        <option value="viewer" <?php if ($data['role'] == 'viewer') echo 'selected'; ?>>Viewer</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <a href="index.php"><button type="submit" name="submit" class="btn btn-primary">Simpan</button></a>
                </td>
            </tr>
            </form>
        </table>
